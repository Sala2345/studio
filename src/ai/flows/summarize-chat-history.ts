'use server';
/**
 * @fileOverview Summarizes the chat history with the AI chatbot.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following chat history. Be concise and focus on the key points discussed. 
