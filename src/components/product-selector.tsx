                ...
                <CardContent>
                    <div className="flex items-center gap-4 p-4 border rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="font-bold text-accent">{new Intl.NumberFormat('en-US', { style: 'currency', currency: selectedProduct.priceRangeV2.minVariantPrice.currencyCode }).format(parseFloat(selectedProduct.priceRangeV2.minVariantPrice.amount))}</p>
                        </div>
                            ...
                            {paginatedProducts.map((product) => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="font-bold text-accent">{new Intl.NumberFormat('en-US', { style: 'currency', currency: product.priceRangeV2.minVariantPrice.currencyCode }).format(parseFloat(product.priceRangeV2.minVariantPrice.amount))}</p>
                                    </div>
                                </Card>
                            ))}
                        </div>
